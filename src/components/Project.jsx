            ...
            <div key={index} className="lg:w-1/3 sm:w-1/2 p-4">
              <div className="flex relative">
                ...
                <img
                  ...
                  src={item.src}
                />
                <div className="px-8 py-10 relative z-10 w-full border-2 bg-gray-500 opacity-0 hover:opacity-100 transition-opacity duration-300 cursor-pointer">
                  <h1 className="title-font text-3xl font-medium text-slate-200 mb-3">{item.title}</h1>
                  <p className="leading-relaxed ">{item.description}</p>
                  <button className=' bg-slate-600 rounded-md px-2 py-1 mt-2 border-2 hover:bg-slate-700 border-gray-400 hover:text-white hover:border-2'><a href={item.href2}>Github</a></button>
                </div>
                </a>
              </div>
            </div>
